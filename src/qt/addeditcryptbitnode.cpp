...
#include "ui_addeditcryptbitnode.h"
...
AddEditCryptbitNode::AddEditCryptbitNode(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AddEditCryptbitNode)
{
    ui->setupUi(this);

}

AddEditCryptbitNode::~AddEditCryptbitNode()
{
    delete ui;
}
...
void AddEditCryptbitNode::on_cancelButton_clicked()
{
    reject();
}
