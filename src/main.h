...
static const int64_t DARKSEND_COLLATERAL = (13342*COIN);
static const int64_t DARKSEND_FEE = (0.0075*COIN);
static const int64_t DARKSEND_POOL_MAX = (133419.99*COIN);
...
inline bool IsProtocolV3(int64_t nTime) { return TestNet() || nTime > 1446249600; }
