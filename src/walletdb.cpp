...
bool CWalletDB::WriteCryptbitNodeConfig(std::string sAlias, const CCryptbitNodeConfig& nodeConfig)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("cryptbit"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadCryptbitNodeConfig(std::string sAlias, CCryptbitNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("cryptbit"), sAlias), nodeConfig);
}

bool CWalletDB::EraseCryptbitNodeConfig(std::string sAlias)
{
    nWalletDBUpdated++;
    return Erase(std::make_pair(std::string("cryptbit"), sAlias));
}
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        else if (strType == "cryptbit")
	{
	    std::string sAlias;
	    ssKey >> sAlias;
	    CCryptbitNodeConfig cryptbitNodeConfig;
	    ssValue >> cryptbitNodeConfig;
	    pwallet->mapMyCryptbitNodes.insert(make_pair(sAlias, cryptbitNodeConfig));
	}
    } catch (...)
    {
        return false;
