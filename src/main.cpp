...
const string strMessageMagic = "Cryptbit Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees, int nHeight)
{
    ...
    else if(nHeight < 19200)
    {
    nSubsidy = 25 * COIN;
    }
    else if(nHeight < 22400)
    {
    nSubsidy = 30 * COIN;
    }
    else if(nHeight < 25600)
    {
    nSubsidy = 40 * COIN;
    }
    ...
    else if(nHeight < 35200)
    {
    nSubsidy = 20 * COIN;
    }
    else if(nHeight < 38400)
    {
    nSubsidy = 15 * COIN;
    }
