...
int nAnonymizeCryptbitAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Cryptbit
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Cryptbit
    // Mac: ~/Library/Application Support/Cryptbit
    // Unix: ~/.cryptbit
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Cryptbit";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "cryptbit.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "cryptbitd.pid"));
