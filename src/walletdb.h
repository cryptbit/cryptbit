...
public:
    ...
    bool WriteCryptbitNodeConfig(std::string sAlias, const CCryptbitNodeConfig& nodeConfig);
    bool ReadCryptbitNodeConfig(std::string sAlias, CCryptbitNodeConfig& nodeConfig);
    bool EraseCryptbitNodeConfig(std::string sAlias);
